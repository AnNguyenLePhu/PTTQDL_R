...
#    - Có outliers không? Ở loài nào? versicolor, virginica
...
# hp tăng → mpg giảm (tương quan âm)
...
par(mfrow = c(2,2))
#    - Grouped bar chart
barplot(data, beside=TRUE, col=rainbow(4),
        main="Bar chart")
#    - Line plot tất cả sản phẩm
matplot(t(data), type="l", lty=1, col=1:4,
        main="Line plot")

#    - Pie chart tổng doanh thu mỗi quý
pie(total_quarter,
    main="Tổng doanh thu quý")
